...
import type { HSB, GameMode, Difficulty, GameState, GameResults } from "@colorcram-v2/types";
import {
  createGame,
  startMemorize,
  startGuess,
...
export const useGameStore = create<GameStore>((set, get) => ({
  ...
  tickBlitz: (elapsedMs) => {
    ...
    // Auto-submit if time expired while player was guessing
