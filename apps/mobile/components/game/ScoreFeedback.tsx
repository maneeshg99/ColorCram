...
const FEEDBACK_POOLS: Record<string, string[]> = {
  ...
  poor: ["Points for confidence.", "That's... a color, alright.", "The vibes are there at least."],
  terrible: ["Were your eyes open?", "Bold strategy, going for the opposite.", "The color wheel weeps."],
};
